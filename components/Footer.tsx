...
const Footer: React.FC = () => {
  return (
    <footer
      id="contact"
      className="px-6 md:px-12 py-20 border-t border-gray-800 bg-[#111] relative overflow-hidden"
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          <span className="font-mono text-neon text-sm mb-4 block">
            Let's work together
          </span>
          ...
          <a
            ...
            className="inline-flex items-center gap-4 text-xl hover:text-neon transition-colors duration-300 font-mono border-b border-gray-700 pb-2 hover:border-neon"
          >
